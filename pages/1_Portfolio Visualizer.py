...
dates_input=st.date_input('This site supports stocks ranging from January 1, 2000 to the current date.',value=(dt.date(2000,1,1),date.today()),max_value=date.today(),min_value=dt.date(2000,1,1))
